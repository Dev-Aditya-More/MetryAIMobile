    ...
    const handleContinue = async () => {
        ...
        try {
            if (userType == "business") {
                router.push("/merchant/(onboarding)/login");
            } else {
                setError("");

                let response = await CustomerAuthService.login(input.email, input.password);
                ...
                // Assuming customer home is at /customer/(home) or similar.
                // If it doesn't exist, this might fail, but based on naming convention it should be fine.
                router.push({
                ...
                >
                    <View style={styles.card}>
                        ...
                        <View style={styles.actions}>
                            ...
                            {/* Forgot Password */}
                            <TouchableOpacity onPress={() => router.push("/customer/(onboarding)/forget-pass")}>
                            ...
                            <TouchableOpacity onPress={() => router.push("/customer/(onboarding)/signup-pass")}>
