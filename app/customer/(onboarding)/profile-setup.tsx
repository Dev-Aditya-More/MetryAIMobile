...
export default function ProfileSetup() {
    ...
    const onContinue = async () => {
        ...
        try {
            // Getting UserId might not be needed if token is enough, but merchant code does it.
            // CustomerAuthService.setupProfile uses token from SecureStore.
            ...
            // Call API
            const response = await CustomerAuthService.setupProfile(payload);

            if (!response.success) {
                Alert.alert("Error", response.error || "Failed to setup profile");
                return;
            }
                        ...
                        >
                            ...
                            >
                                ...
                                <View style={styles.headerRow}>
                                    ...
                                    {/* Removed progress bar or adapted it since steps might differ for customer */}
