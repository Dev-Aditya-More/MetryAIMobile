    ...
    const handleContinue = async () => {
        ...
        try {
            if (userType == "business") {
                ...
                router.push("/merchant/(onboarding)/signup-pass");
            } else {
                setError("");

                // Pass "user" as default name or handle it in profile setup?
                // CustomerAuthService.signup(fullname, email, password)
                // The merchant signup has: .signup("user", input.email, input.password);
                // CustomerAuthService.signup signature is: (fullname: string, email: string, password: string)
                const response = await CustomerAuthService.signup("user", input.email, input.password);
                ...
                router.push({
                    pathname: "/customer/(onboarding)/profile-setup" as any,
                ...
                >
                    <View style={styles.card}>
                        ...
                        <View style={styles.actions}>
                            ...
                            <TouchableOpacity onPress={() => router.push("/customer/(onboarding)/login")}>
